...
CREATE TABLE IF NOT EXISTS telemetria_equipos (
  ...
  horometro               NUMERIC(12, 3) NOT NULL DEFAULT 0,
  promedio_h              NUMERIC(10, 3),
  ciudad                  TEXT,
  ultima_fecha_comunicacion TIMESTAMPTZ,
  latitud                 NUMERIC(12, 6),
  longitud                NUMERIC(12, 6),
  dias_primer_mtto        NUMERIC(10, 3),
  proximo_primer_mtto     NUMERIC(10, 3),
  dias_segundo_mtto       NUMERIC(10, 3),
  proximo_segundo_mtto    NUMERIC(10, 3),
  dias_tercer_mtto        NUMERIC(10, 3),
  proximo_tercer_mtto     NUMERIC(10, 3),
  fecha_primer_mtto       DATE,
  fecha_segundo_mtto      DATE,
  fecha_tercer_mtto       DATE,
  distancia_bogota        NUMERIC(14, 6),
  distancia_medellin      NUMERIC(14, 6),
  distancia_barranquilla  NUMERIC(14, 6),
  distancia_monteria       NUMERIC(14, 6),
  distancia_cali          NUMERIC(14, 6),
  distancia_bucaramanga   NUMERIC(14, 6),
  distancia_ibague        NUMERIC(14, 6),
  distancia_istmina       NUMERIC(14, 6),
  distancia_minima        NUMERIC(14, 6),
  sede                    TEXT,
